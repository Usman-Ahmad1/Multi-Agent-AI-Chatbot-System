        ...
        for msg in st.session_state.chat_history:
            if msg['role'] == 'user':
                ...
                <div style="display: flex; justify-content: flex-end; margin: 0.5rem 0;">
                    <div style="background: #667eea; color: white; padding: 0.8rem 1.2rem; border-radius: 15px 15px 5px 15px; max-width: 70%;">
                ...
                <div style="display: flex; justify-content: flex-start; margin: 0.5rem 0;">
                    <div style="background: #f0f2f6; padding: 0.8rem 1.2rem; border-radius: 15px 15px 15px 5px; max-width: 70%;">
                        <strong>🤖 AI</strong><br>
                        {msg['content']}
